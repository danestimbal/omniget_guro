...
<section class="tab">
  <SettingsField
    label="SponsorBlock"
    description="Skips sponsored segments flagged by the community. Requests use a hash prefix of the video ID, preserving privacy."
  >
    <SettingsToggle
      value={enabled}
  ...
  {#if enabled}
    <SettingsField
      ...
      description="When on, segments are skipped without asking for confirmation. Recommended: leave off to respect creators."
    >
      <SettingsToggle
        value={autoSkip}
