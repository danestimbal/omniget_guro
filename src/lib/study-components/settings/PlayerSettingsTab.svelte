...
<section class="tab">
  <SettingsField
    ...
    description="Percentage of the video from which a lesson is marked complete"
  ...
  <SettingsField
    label="Long skip"
    description="Jump time with J/L (shortcut)"
  ...
  <SettingsField
    label="Short skip"
    description="Jump time with Shift+J/L"
  ...
  >
    <SettingsToggle
      ...
      ariaLabel="Pause on minimize"
    />
  </SettingsField>

  <SettingsField
    label="ESC exits fullscreen"
    description="When on, ESC exits fullscreen. When off, ESC closes the lesson"
  >
    <SettingsToggle
