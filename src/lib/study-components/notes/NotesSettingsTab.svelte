...
<section class="tab">
  <header class="tab-head">
    <div>
      <h2>Notes</h2>
      <p class="hint">Appearance, sidebar, editor, journal, refs, maintenance.</p>
    </div>
    <div class="status">
      {#if loading}
  ...
  {#if !loading}
    <article class="card">
      ...
      <div class="rows">
        ...
        <label class="row">
          ...
          >
            <option value="compact">Compact (640px)</option>
    ...
    <article class="card">
      ...
      <div class="rows">
        ...
        <label class="row check">
          ...
          />
          <span>Show "Recents" section</span>
        </label>
        <label class="row check">
          <input
            type="checkbox"
    ...
    <article class="card">
      ...
      <div class="rows">
        ...
        <label class="row check">
          ...
          />
          <span>Drag handle visible on hover</span>
        </label>
        <label class="row">
          ...
          >
            ...
            <option value="1000">1000ms (light on writes)</option>
          </select>
        </label>
      </div>
    </article>
    ...
    <article class="card">
      ...
      <div class="rows">
        <label class="row">
          ...
          >
            <option value="none">None (blank page)</option>
        ...
        <label class="row check">
          ...
          />
          <span>Global shortcut Ctrl+J opens today's journal</span>
        </label>
      </div>
    </article>
    ...
    <article class="card">
      ...
      <div class="rows">
        ...
        <label class="row">
          <span>Preview blocks in the popover</span>
          <select
    ...
    <article class="card">
      ...
      <div class="rows">
        ...
        <label class="row check">
          ...
          />
          <span>Debug mode (verbose logs in devtools)</span>
        </label>
      </div>
    </article>
