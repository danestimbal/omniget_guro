<script lang="ts">
  ...
  const TREE_NODES: TreeNode[] = [
    { code: "xp:100", label: "100 XP", description: "Reach 100 XP", family: "xp", tier: "bronze", threshold: 100, icon: "✨" },
    { code: "xp:500", label: "500 XP", description: "Reach 500 XP", family: "xp", tier: "bronze", threshold: 500, icon: "⭐", requires: "xp:100" },
    ...
    { code: "lessons:1", label: "First lesson", description: "Complete a lesson", family: "lessons", tier: "bronze", threshold: 1, counterKey: "lessons_completed", icon: "🎓" },
    ...
    { code: "lessons:50", label: "50 lessons", description: "Half a century", family: "lessons", tier: "silver", threshold: 50, counterKey: "lessons_completed", icon: "📖", requires: "lessons:10" },
    ...
    { code: "focus:60", label: "1h focused", description: "1h of focus", family: "focus", tier: "bronze", threshold: 60, counterKey: "focus_minutes", icon: "🧘" },
    { code: "focus:600", label: "10h focused", description: "10h of focus", family: "focus", tier: "silver", threshold: 600, counterKey: "focus_minutes", icon: "🎯", requires: "focus:60" },
    { code: "focus:6000", label: "100h focused", description: "100h of focus", family: "focus", tier: "gold", threshold: 6000, counterKey: "focus_minutes", icon: "🔥", requires: "focus:600" },
    ...
    { code: "streak:30", label: "30 days", description: "A whole month", family: "streak", tier: "silver", threshold: 30, icon: "🔥🔥🔥", requires: "streak:7" },
    { code: "streak:100", label: "100 days", description: "Steel habit", family: "streak", tier: "gold", threshold: 100, icon: "🏅", requires: "streak:30" },
  ];
...
<section class="tree-page">
  ...
  <header class="actions">
    ...
    <a class="link" href="/study/achievements/charts">Progression charts →</a>
  </header>
